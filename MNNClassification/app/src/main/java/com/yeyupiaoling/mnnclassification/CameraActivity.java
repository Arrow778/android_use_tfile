...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 加载模型和标签
        classNames = Utils.ReadListFromFile(getAssets(), "label_muti.txt");
        System.out.println("classNames : " + classNames.size());
        String classificationModelPath = getCacheDir().getAbsolutePath() + File.separator + "model.mnn";
        Utils.copyFileFromAsset(CameraActivity.this, "model.mnn", classificationModelPath);
        try {
            mnnClassification = new MNNClassification(classificationModelPath);
            Toast.makeText(CameraActivity.this, "模型加载成功！可识别的种类个数" + classNames.size(), Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
